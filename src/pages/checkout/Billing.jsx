    ...
    <div className="checkout__form-container">
      ...
      <div className="checkout__billing">
        ...
        <div className="form-container">
          ...
          <input required onChange={handleChange} className={emailClassInput} id="email" type="email" value={message} placeholder="alexeiward@mail.com" />
        </div>

        <div className="form-container">
          <label htmlFor="phoneNumber">Phone Number</label>
          <input required id="phoneNumber" type="number" placeholder="+1 202-555-0136" />
        </div>
      </div>
    </div>
  );
